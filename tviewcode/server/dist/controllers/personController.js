 ...
 * @access  Public
 */
export const getAllPersons = asyncHandler(async (_req, res) => {
 ...
 * @access  Public
 */
export const getPersonEvents = asyncHandler(async (req, res) => {
 ...
 * @access  Public
 */
export const getPersonRelationships = asyncHandler(async (req, res) => {
 ...
 * @access  Public
 */
export const getPersonFamily = asyncHandler(async (req, res) => {
    ...
    for (const rel of relationships) {
        const otherPersonIds = rel.persons
            ...
            .map(id => id.toString());
        const relatedPersons = familyMembers.filter(p => otherPersonIds.includes(p._id.toString()));
